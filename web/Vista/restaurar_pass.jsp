        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center d-inline-block" href="/"><img src="../assets/img/restaurantlogo.png" width="50"><span id="menu" class="mx-1" style="font-family: Artifika, serif;">Puro Sabor Peruano</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="galeria.jsp" style="font-family: Artifika, serif;">Galerí­a</a></li>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-dark mb-2">Ingrese la dirección de correo electrónico asociada a su cuenta<br>y le enviaremos un enlace para restablecer su contraseÃ±a.</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card">
                        <div class="card-body d-flex flex-column align-items-center p-0">
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary text-bg-warning shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-wrench-adjustable">
                            ...
                            <form class="w-100 px-5" method="post">
                                ...
                                <div class="mb-3"><button class="btn btn-primary bg-dark shadow-lg d-block w-100" type="submit">Continuar</button></div>
                                <p class="text-light text-center">¿No tienes una cuenta?&nbsp;<a href="registro.jsp">Registrarme</a></p>
                            </form>
                        </div>
                    </div>
                </div>
